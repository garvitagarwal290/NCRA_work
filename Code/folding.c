...
int main(int argc, char* argv[])
{
	...
	FILE *shotwell = popen("shotwell folded.png","r");
	...
	char title[100] = "set title 'Folded - "; strcat(title,argv[1]);
	char *gnuplotcommands[] = {title,"set terminal png size 800,600", "set output 'folded.png'" ,"plot \"folded.txt\" u 1:2 w lp"};
