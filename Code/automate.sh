...
do 
	...
	#running pulse_energy.c code on the pulses.bin file
	echo -e "Running pulse_energy.c code for $pulsar.."
	cd ${pulsar_dir}${pulsar}/pulse_energy
	gcc /home/ygupta/work_area/garvit/C_code/pulse_energy/pulse_energy.c -o /home/ygupta/work_area/garvit/C_code/pulse_energy/pulse_energy -lm -std=gnu99
	./../../C_code/pulse_energy/pulse_energy -s ${num_offpulsestats_ranges[$REPLY-1]} -m ${num_offpulsemean_ranges[$REPLY-1]} -p ${num_onpulse_ranges[$REPLY-1]} ../../${pulsar}/stacked_profiles/pulses.bin  
